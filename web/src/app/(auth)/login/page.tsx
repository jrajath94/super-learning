    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-4">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-gradient-radial from-accent/20 via-accent-secondary/10 to-transparent opacity-50 blur-3xl" />
            </div>
                ...
                <div className="glass rounded-2xl p-8">
                    ...
                    <div className="relative my-6">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-2 bg-background-secondary text-foreground-muted">or continue with</span>
                        </div>
                    </div>

                    {/* Social Login */}
                    <div className="grid grid-cols-2 gap-3">
                        <button className="flex items-center justify-center gap-2 px-4 py-3 bg-background-secondary border border-border rounded-xl hover:border-accent transition-all">
